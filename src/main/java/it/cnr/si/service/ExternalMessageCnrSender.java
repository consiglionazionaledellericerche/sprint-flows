...
@Profile({"cnr"})
@Configuration
public class ExternalMessageCnrSender implements ExternalMessageSender{

    private final Logger log = LoggerFactory.getLogger(ExternalMessageCnrSender.class);
