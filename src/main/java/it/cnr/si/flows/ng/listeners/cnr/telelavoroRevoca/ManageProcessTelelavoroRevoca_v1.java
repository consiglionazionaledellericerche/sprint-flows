package it.cnr.si.flows.ng.listeners.cnr.telelavoroRevoca;
...
@Component
@Profile("cnr")
public class ManageProcessTelelavoroRevoca_v1 implements ExecutionListener {
	private static final long serialVersionUID = 686169707042367215L;
	private static final Logger LOGGER = LoggerFactory.getLogger(ManageProcessTelelavoroRevoca_v1.class);
