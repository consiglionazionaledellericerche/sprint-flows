...
public class AceBridgeService {
    ...
    public List<SimpleEntitaOrganizzativaWebDto> getUoByTipo(TipiEntitaOrganizzativa tipo) {
    ...
    public List<SimpleEntitaOrganizzativaWebDto> cercaIstituto(String search) {
        return aceService.entitaOrganizzativaFind(null, search, LocalDate.now(), TipiEntitaOrganizzativa.ISTITUTO, null);
    }
}