...
@Service
public class StartControFirmaMultiSetGroupsAndVisibility {
	private static final Logger LOGGER = LoggerFactory.getLogger(StartControFirmaMultiSetGroupsAndVisibility.class);
