...
@Component
@Profile("cnr")
public class ManageProcessControFirmaMulti_v1 implements ExecutionListener {
	private static final long serialVersionUID = 686169707042367215L;
	private static final Logger LOGGER = LoggerFactory.getLogger(ManageProcessControFirmaMulti_v1.class);
	...
	@Inject
	private StartControFirmaMultiSetGroupsAndVisibility startFirmaDocumentiSetGroupsAndVisibility;
	@Inject
