...
@Component
@Profile("cnr")
public class ManageProcessLaboratoriCongiuntiBandoDipartimento_v1 implements ExecutionListener {
	private static final long serialVersionUID = 686169707042367215L;
	private static final Logger LOGGER = LoggerFactory.getLogger(ManageProcessLaboratoriCongiuntiBandoDipartimento_v1.class);
	...
	@Inject
	private StartLaboratoriCongiuntiBandoDipartimentoSetGroupsAndVisibility startShortTermMobilityBandoDipartimentoSetGroupsAndVisibility;
	@Inject
...
//					.list();
	...
	private void creaExportCsvDomandePerBandoDipartimento(DelegateExecution execution, String idBando, String dipartimentoId) throws IOException {
		...
		String processDefinitionKey = "laboratori-congiunti-domande";
