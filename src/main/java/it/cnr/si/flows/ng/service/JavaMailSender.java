...
//        
//        env.getProperty("cnr.mail.port");
//        
//        setPort(
//                Optional.ofNullable(javaMailProperties.get(env.getProperty("cnr.mail.mail.port")))
//                    .filter(Integer.class::isInstance)
//                    .map(Integer.class::cast)
//                    .orElse(null)
//        );
//        setUsername(javaMailProperties.getProperty(env.getProperty("cnr.mail.mail.user")));
//        setPassword(javaMailProperties.getProperty(env.getProperty("cnr.mail.password")));
