	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		if (execution.getVariableInstance("motivazioneEliminazione") == null) {
			...
			case "endevent-annullata-start": {
				<hr><p><metadatum label="Parere motivato" value="{{$parent.vm.data.entity.variabili.commento}}" type=""> </metadatum><metadatum label="Parere motivato" value="{{$parent.vm.data.entity.variabili.scadenzaTempiProcedura}}" type=""> </metadatum></p></hr><hr><p><strong><u>SCHEDA MONITORAGGIO</u><metadatum label="TIPOLOGIA" value="{{$parent.vm.data.entity.variabili.tipoAttivita}}" type=""> </metadatum><metadatum label="anno" value="{{$parent.vm.data.entity.variabili.anno}}" type=""> </metadatum><metadatum label="mese" value="{{$parent.vm.data.entity.variabili.mese}}" type=""> </metadatum></strong></p></hr><metadatum label="Nome Cognome" value="{{$parent.vm.data.entity.variabili.nomeCognomeUtente}}" type=""> </metadatum><metadatum label="matricola" value="{{$parent.vm.data.entity.variabili.matricolaRichiedente}}" type=""> </metadatum><metadatum label="Livelo Utente Richiedente" value="{{$parent.vm.data.entity.variabili.livelloRichiedente}}" type=""> </metadatum><metadatum label="Profilo Utente Richiedente" value="{{$parent.vm.data.entity.variabili.profiloRichiedente}}" type=""> </metadatum><metadatum label="Codice Sede Utente Richiedente" value="{{$parent.vm.data.entity.variabili.idNsipRichiedente}}" type=""> </metadatum><metadatum label="Codice Sede Struttura Valutazione Dirigente" value="{{$parent.vm.data.entity.variabili.idNsipStrutturaDomandaRichiedente}}" type=""> </metadatum><metadatum label="Struttura Valutazione Dirigente" value="{{$parent.vm.data.entity.variabili.strutturaValutazioneDirigente}}" type=""> </metadatum><metadatum label="Scadenza presentazione Domanda" value="{{$parent.vm.data.entity.variabili.scadenzaPresentazioneDomande | date : 'dd/MM/yyyy'}}" type=""> </metadatum><metadatum label="Data Chiusura Domanda" value="{{$parent.vm.data.entity.variabili.dataChiusuraDomanda}}" type=""> </metadatum><metadatum label="Data presentazione Domanda" value="{{$parent.vm.data.entity.variabili.dataPresentazioneDomanda | date : 'dd/MM/yyyy'}}" type=""> </metadatum><metadatum label="Data inizio Smart Working" value="{{$parent.vm.data.entity.variabili.dataInizioSmartWorking | date : 'dd/MM/yyyy'}}" type=""> </metadatum><metadatum label="Data fine Smart Working" value="{{$parent.vm.data.entity.variabili.dataFineSmartWorking | date : 'dd/MM/yyyy'}}" type=""> </metadatum>				execution.setVariable("statoFinaleDomanda", Enum.StatoDomandeSmartWorkingEnum.ANNULLATA.toString());
