...
public class ManageProcessSmartWorkingDomanda_v1 implements ExecutionListener {
	...
	public void restToApplicazioneSiper(DelegateExecution execution, StatoDomandeLABEnum statoDomanda) {
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		if (execution.getVariableInstance("motivazioneEliminazione") == null) {
			...
			case "modifica-start": {
				restToApplicazioneSiper(execution, Enum.StatoDomandeLABEnum.APERTA);
			};break;
			...
			case "pre-accettazione-start": {
				if(sceltaUtente.equals("Respingi")) {
					...
					execution.setVariable("tipologiaRespinta", "respintaResponsabile");
					//restToApplicazioneSiper(execution, Enum.StatoDomandeLABEnum.RESPINTA);
					...
					if(sceltaUtente.equals("Annulla")) {
						...
						//restToApplicazioneSiper(execution, Enum.StatoDomandeLABEnum.ANNULLATA);
						...
						//restToApplicazioneSiper(execution, Enum.StatoDomandeLABEnum.VALIDATA);
			...
			case "endevent-autorizzata-start": {
				...
				restToApplicazioneSiper(execution, Enum.StatoDomandeLABEnum.AUTORIZZATA);
			...
			case "accettazione-end": {
				...
				if(!sceltaUtente.equals("Respingi")) {
					...
					//restToApplicazioneSiper(execution, Enum.StatoDomandeLABEnum.ACCETTATA);
			...
			case "valutazione-scientifica-end": {
				...
				if(execution.getVariable("sceltaUtente").equals("CambiaDipartimento")) {
					...
					//restToApplicazioneSiper(execution, Enum.StatoDomandeLABEnum.VALUTATA_SCIENTIFICAMENTE);
			...
			restToApplicazioneSiper(execution, Enum.StatoDomandeLABEnum.CANCELLATA);
