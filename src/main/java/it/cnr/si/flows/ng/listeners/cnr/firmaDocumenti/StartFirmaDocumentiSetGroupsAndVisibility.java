...
@Service
public class StartFirmaDocumentiSetGroupsAndVisibility {
	private static final Logger LOGGER = LoggerFactory.getLogger(StartFirmaDocumentiSetGroupsAndVisibility.class);
