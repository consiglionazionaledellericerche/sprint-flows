(function() {
    ...
    UserMembershipNewController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Membership'];

    function UserMembershipNewController($timeout, $scope, $stateParams, $uibModalInstance, entity, Membership) {
        var vm = this;
