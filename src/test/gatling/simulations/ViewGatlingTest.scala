...
/**
 * Performance test for the View entity.
 */
class ViewGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the View entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created view")
                .get("${new_view_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created view")
            .delete("${new_view_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
