...
/**
 * Performance test for the Cnrauthority entity.
 */
class CnrauthorityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Cnrauthority entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all cnrauthorities")
            .get("/api/cnrauthorities")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created cnrauthority")
                .get("${new_cnrauthority_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created cnrauthority")
            .delete("${new_cnrauthority_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
