...
/**
 * Performance test for the ExternalMessage entity.
 */
class ExternalMessageGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ExternalMessage entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all externalMessages")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created externalMessage")
                .get("${new_externalMessage_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created externalMessage")
            .delete("${new_externalMessage_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
