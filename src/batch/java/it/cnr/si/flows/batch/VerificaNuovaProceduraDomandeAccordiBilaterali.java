...
public class VerificaNuovaProceduraDomandeAccordiBilaterali {

	private static final Logger log = LoggerFactory.getLogger(VerificaNuovaProceduraDomandeAccordiBilaterali.class);
