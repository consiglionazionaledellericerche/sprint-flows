...
Il presente manuale vuole essere una guida all'utilizzo del flusso di lavoro informatizzato all'interno dalla piattaforma &quot;Scrivania Digitale&quot;, un'applicazione con interfaccia web che permette di definire ed eseguire flussi di lavoro che comportano l'assegnazione di compiti a diversi attori e la raccolta di informazioni e documentazione relativi alle attività amministrative.
...
- **Semplificar**e (firma leggera, firma digitale, reingegnerizzazione)
- **Velocizzare (**smistamento ed assegnazione in automatico dei compiti ai diversi attori coinvolti);
- **Organizza**re (ogni utente ha la lista dei propri compiti)
...
- **Facilitare** adempimento agli obblighi Normativi (per Acquisti adempimento automatico degli obblighi di trasparenza.)
...
Le aree di testo consentono di inserire descrizioni più lunghe, che può essere distribuito su più righe.
...
Il numero di protocollo è uno di quei parametri che può essere ricercato nell'applicazione da pannello ricerca. Il risultato indicherà il flusso che possiede quel documento. Dai dettagli del flusso sarà possibile recuperare tutti i dati necessari e scaricare il file.

## Modifica Documenti

I documenti inseriti posso essere modificabili nel task, se il task lo prevede, o direttamente dai ruoli a cui è stato dato il permesso di cambiarli. Potranno essere cambiati tutti i metadati e caricato un nuovo file in sostituzione del vecchio (nuova versione del documento) come già descritto nel paragrafo Gestione Documenti tranne nel caso un file non sia stato già firmato e protocollato (Documenti tipo 4)
...
1. Restituire il compito al gruppo cliccando sulla voce “Restituisci al gruppo” e quindi renderlo di nuovo visibile nella SEZIONE centrale “I miei compiti”;
2. Svolgere direttamente il compito cliccando sulla voce “Dettagli Flusso”,

Una volta cliccato sul bottone “dettagli” l’utente viene così dirottato sulla PAGINA dei dettagli del flusso perché possano essere operate le azioni necessarie per il proseguimento del flusso.
...
A destra si ha il diagramma del flusso con evidenziato nello specifico il compito in cui ci si trova il flusso. L’immagine piò essere ingrandita cliccando sopra l’immagine stessa. 

Tramite il bottone “Visualizza Cronologia”, situato sotto il digramma è possibile vedere i dettagli dei compiti svolti fino ad ora su quell’istanza di flusso.

Tramite il bottone “Export Summary”, situato sotto il bottone “Visualizza Cronologia”, è possibile esportare un flie pdf contente le informazioni dei dettagli del flusso.
...
- Quelli ancora attivi, mostrati di default o visibili cliccando sul bottone di sinistra “Flussi attivi”
- Quelli terminati mostrati visibili cliccando sul bottone di destra “Flussi terminati”

Nella SEZIONE di sinistra della pagina è presente una serie di campi di inserimento e selezione per filtrare i risultati. L’elenco può essere filtrato per attributi comuni ad ogni flusso quali: Identificativo Flusso, Parole Chiave Titolo del Flusso e Descrizione, Utente che ha avviato il Flusso, Numeri di protocollo Documenti e le date relative all’avvio del flusso. 

Selezionando la tipologia del flusso dall’elenco esposto nel campo “Tipologie” vengono presentati campi di filtro specifici per quella tipologia di flusso in modo da poter avere a disposizione una ricerca più specifica.

L’elenco è, di default, ordinato per data decrescente ossia da i flussi avviati prima a quelli più recenti. 

Una volta avuti i risultati della ricerca, cliccando sul bottone “dettagli” si visualizzerà la PAGINA dove sono contenute le informazioni utili relative a quel flusso.
